package {
	...
	public class VideoPlayer extends Sprite {
		...
		private var sources:Array = ["dog/Dog.flv", "Reporter/Repoter.flv", "kiss/Kiss.flv","thank/Thank.flv"];
		...
		//	flv.getVideoPlayer(0).smoothing = true;
			...
			diyData = JSON.deserialize('["这里是昵称哦","images/1.jpg"]');
		...
		function onEnddingHandler(evt:MetadataEvent):void {
			...
			switch(evt.info.name) {
				...
				case "start":
					cover.visible = true;
					if (index == 3) {
						trace("ssssssssssssssssssss");
						control.showImage(index);
					}
					break;
			}
		}
