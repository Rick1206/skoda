package code.tool
{
	...
	public class ScrollBar2
	{
		...
		*/  
		public function ScrollBar2($target:DisplayObjectContainer, $maskTarget:*, $scrollBar:MovieClip, $scrollLine:Sprite, $tween:Number = 5, $elastic:Boolean = false, $lineAbleClick:Boolean = false , $mouseWheel:Boolean = false, $direction:String = "L") 
		{
		...
		*/  
		...
		private function makeScrollBar():void 
		{
			...
			_scrollBar.addEventListener(MouseEvent.ROLL_OVER,mouseStr);;
			_scrollBar.addEventListener(MouseEvent.ROLL_OUT,mouseStr);
		...
		private function mouseStr(e:Event)
		{
			switch (e.type)
			{
